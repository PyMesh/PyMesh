...
#include <Boolean/CGAL/CGALBooleanEngine.h>

#include "../BooleanEngineTest.h"

class CGALBooleanEngineTest : public BooleanEngineTest {
    protected:
...
TEST_F(CGALBooleanEngineTest, disjoint_symmetric_difference) {
    ...
    BooleanPtr cgal_engine = get_disjoint_setting(mesh);
    cgal_engine->compute_symmetric_difference();
...
TEST_F(CGALBooleanEngineTest, overlap_symmetric_difference) {
    ...
    BooleanPtr cgal_engine = get_overlap_setting(mesh);
    ASSERT_THROW(cgal_engine->compute_symmetric_difference(), RuntimeError);
