...
#pragma omp parallel for if (m>WINDING_NUMBER_OMP_MIN_VALUE && no>1)
  // loop over faces
  for(int f = 0;f<m;f++)
  {
    // Gather corners 
...
template void winding_number_3<int>(double const*, int, int const*, int, double const*, int, double*);
template void winding_number_2<double>(double const*, int, double const*, int, double const*, int, double*);
template void winding_number_3<double>(double const*, int, double const*, int, double const*, int, double*);
